...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "utils.articulation_points",
        "sources": [
            "./utils/articulation_points.pyx"
        ]
    },
    "module_name": "utils.articulation_points"
}
END: Cython Metadata */
...
#define __PYX_HAVE__utils__articulation_points
#define __PYX_HAVE_API__utils__articulation_points
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'utils.articulation_points' */
...
static PyObject *__pyx_f_5utils_19articulation_points_APUtil(int *, __Pyx_memviewslice, PyObject *, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static __Pyx_memviewslice __pyx_f_5utils_19articulation_points_articulationPoints(__Pyx_memviewslice, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "utils.articulation_points"
extern int __pyx_module_is_main_utils__articulation_points;
int __pyx_module_is_main_utils__articulation_points = 0;

/* Implementation of 'utils.articulation_points' */
...
static const char __pyx_k_tile_districts[] = "tile_districts";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_pyx_PickleError[] = "__pyx_PickleError";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_tile_neighbours[] = "tile_neighbours";
...
static PyObject *__pyx_n_s_tile_districts;
static PyObject *__pyx_n_s_tile_neighbours;
...
static PyObject *__pyx_pf_5utils_19articulation_points_articulationPoints(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_tile_districts, PyObject *__pyx_v_map); /* proto */
...
/* "utils/articulation_points.pyx":10
 * import numpy as np
 * 
 * cdef APUtil(             # <<<<<<<<<<<<<<
 *     int *time,
...
static PyObject *__pyx_f_5utils_19articulation_points_APUtil(int *__pyx_v_time, __Pyx_memviewslice __pyx_v_tile_districts, PyObject *__pyx_v_map, int __pyx_v_u, __Pyx_memviewslice __pyx_v_visited, __Pyx_memviewslice __pyx_v_ap, __Pyx_memviewslice __pyx_v_parent, __Pyx_memviewslice __pyx_v_low, __Pyx_memviewslice __pyx_v_disc) {
  int __pyx_v_v;
  int __pyx_v_children;
  ...
  __Pyx_RefNannySetupContext("APUtil", 0);

  /* "utils/articulation_points.pyx":23
 *     cdef int v
 ...
 */
  ...
  /* "utils/articulation_points.pyx":26
 * 
 *     # Mark the current node as visited and print it
 *     visited[ u ] = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_u;
  *((int *) ( /* dim=0 */ (__pyx_v_visited.data + __pyx_t_1 * __pyx_v_visited.strides[0]) )) = 1;

  /* "utils/articulation_points.pyx":29
 * 
 *     # Initialize discovery time and low value
 *     disc[u] = time[0]             # <<<<<<<<<<<<<<
 *     low[u] = time[0]
 ...
 */
  __pyx_t_2 = __pyx_v_u;
  *((double *) ( /* dim=0 */ (__pyx_v_disc.data + __pyx_t_2 * __pyx_v_disc.strides[0]) )) = (__pyx_v_time[0]);

  /* "utils/articulation_points.pyx":30
 *     # Initialize discovery time and low value
 *     disc[u] = time[0]
 *     low[u] = time[0]             # <<<<<<<<<<<<<<
 *     time[0] += 1
 ...
 */
  __pyx_t_3 = __pyx_v_u;
  *((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_3 * __pyx_v_low.strides[0]) )) = (__pyx_v_time[0]);

  /* "utils/articulation_points.pyx":31
 *     disc[u] = time[0]
 *     low[u] = time[0]
 *     time[0] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_4 = 0;
  (__pyx_v_time[__pyx_t_4]) = ((__pyx_v_time[__pyx_t_4]) + 1);

  /* "utils/articulation_points.pyx":33
 *     time[0] += 1
 * 
 *     cdef list neighbors = map.tile_neighbours[u]             # <<<<<<<<<<<<<<
 *     for v in neighbors:
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_map, __pyx_n_s_tile_neighbours); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_GetItemInt(__pyx_t_5, __pyx_v_u, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 33, __pyx_L1_error)
  ...
  __pyx_v_neighbors = ((PyObject*)__pyx_t_6);
  __pyx_t_6 = 0;

  /* "utils/articulation_points.pyx":34
 * 
 *     cdef list neighbors = map.tile_neighbours[u]
 *     for v in neighbors:             # <<<<<<<<<<<<<<
 *         # Dont count connections between tiles of differnet districts.
 ...
 */
  ...
  __pyx_t_6 = __pyx_v_neighbors; __Pyx_INCREF(__pyx_t_6); __pyx_t_7 = 0;
  for (;;) {
    if (__pyx_t_7 >= PyList_GET_SIZE(__pyx_t_6)) break;
    #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
    __pyx_t_5 = PyList_GET_ITEM(__pyx_t_6, __pyx_t_7); __Pyx_INCREF(__pyx_t_5); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 34, __pyx_L1_error)
    #else
    __pyx_t_5 = PySequence_ITEM(__pyx_t_6, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    #endif
    __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_5); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_v = __pyx_t_8;

    /* "utils/articulation_points.pyx":36
 *     for v in neighbors:
 *         # Dont count connections between tiles of differnet districts.
 *         if (tile_districts[u] != tile_districts[v]):             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    __pyx_t_11 = (((*((int *) ( /* dim=0 */ (__pyx_v_tile_districts.data + __pyx_t_9 * __pyx_v_tile_districts.strides[0]) ))) != (*((int *) ( /* dim=0 */ (__pyx_v_tile_districts.data + __pyx_t_10 * __pyx_v_tile_districts.strides[0]) )))) != 0);
    if (__pyx_t_11) {

      /* "utils/articulation_points.pyx":37
 *         # Dont count connections between tiles of differnet districts.
 *         if (tile_districts[u] != tile_districts[v]):
 *             continue             # <<<<<<<<<<<<<<
 *         # If v is not visited yet, then make it a child of u
 ...
 */
    ...
    /* "utils/articulation_points.pyx":40
 *         # If v is not visited yet, then make it a child of u
 *         # in DFS tree and recur for it
 *         if visited[v] == False:             # <<<<<<<<<<<<<<
 *             parent[v] = u
 ...
 */
    ...
    __pyx_t_11 = (((*((int *) ( /* dim=0 */ (__pyx_v_visited.data + __pyx_t_12 * __pyx_v_visited.strides[0]) ))) == 0) != 0);
    if (__pyx_t_11) {

      /* "utils/articulation_points.pyx":41
 *         # in DFS tree and recur for it
 *         if visited[v] == False:
 *             parent[v] = u             # <<<<<<<<<<<<<<
 *             children += 1
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_parent.data + __pyx_t_13 * __pyx_v_parent.strides[0]) )) = __pyx_v_u;

      /* "utils/articulation_points.pyx":42
 *         if visited[v] == False:
 *             parent[v] = u
 *             children += 1             # <<<<<<<<<<<<<<
 *             APUtil(time, tile_districts, map, v, visited, ap, parent, low, disc)
 * 
 */
      __pyx_v_children = (__pyx_v_children + 1);

      /* "utils/articulation_points.pyx":43
 *             parent[v] = u
 *             children += 1
 *             APUtil(time, tile_districts, map, v, visited, ap, parent, low, disc)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_5 = __pyx_f_5utils_19articulation_points_APUtil(__pyx_v_time, __pyx_v_tile_districts, __pyx_v_map, __pyx_v_v, __pyx_v_visited, __pyx_v_ap, __pyx_v_parent, __pyx_v_low, __pyx_v_disc); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

      /* "utils/articulation_points.pyx":47
 *             # Check if the subtree rooted with v has a connection to
 ...
 */
      ...
      __pyx_t_15 = (*((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_14 * __pyx_v_low.strides[0]) )));
      __pyx_t_16 = __pyx_v_u;
      __pyx_t_17 = (*((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_16 * __pyx_v_low.strides[0]) )));
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_19 * __pyx_v_low.strides[0]) )) = __pyx_t_18;

      /* "utils/articulation_points.pyx":51
 *             # u is an articulation point in following cases
 ...
 */
      ...
      __pyx_t_21 = (((*((int *) ( /* dim=0 */ (__pyx_v_parent.data + __pyx_t_20 * __pyx_v_parent.strides[0]) ))) == -1L) != 0);
      if (__pyx_t_21) {
      } else {
        __pyx_t_11 = __pyx_t_21;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_21 = ((__pyx_v_children > 1) != 0);
      __pyx_t_11 = __pyx_t_21;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_11) {

        /* "utils/articulation_points.pyx":52
 *             # (1) u is root of DFS tree and has two or more chilren.
 *             if parent[u] == -1 and children > 1:
 *                 ap[u] = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((int *) ( /* dim=0 */ (__pyx_v_ap.data + __pyx_t_22 * __pyx_v_ap.strides[0]) )) = 1;
 ...
 */
      ...
      /* "utils/articulation_points.pyx":56
 *             #(2) If u is not root and low value of one of its child is more
 ...
 */
      ...
      __pyx_t_21 = (((*((int *) ( /* dim=0 */ (__pyx_v_parent.data + __pyx_t_23 * __pyx_v_parent.strides[0]) ))) != -1L) != 0);
      if (__pyx_t_21) {
      } else {
        __pyx_t_11 = __pyx_t_21;
      ...
      __pyx_t_21 = (((*((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_24 * __pyx_v_low.strides[0]) ))) >= (*((double *) ( /* dim=0 */ (__pyx_v_disc.data + __pyx_t_25 * __pyx_v_disc.strides[0]) )))) != 0);
      __pyx_t_11 = __pyx_t_21;
      __pyx_L11_bool_binop_done:;
      if (__pyx_t_11) {

        /* "utils/articulation_points.pyx":57
 *             # than discovery value of u.
 *             if parent[u] != -1 and low[v] >= disc[u]:
 *                 ap[u] = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((int *) ( /* dim=0 */ (__pyx_v_ap.data + __pyx_t_26 * __pyx_v_ap.strides[0]) )) = 1;
 ...
 */
    ...
    /* "utils/articulation_points.pyx":60
 * 
 *         # Update low value of u for parent function calls
 *         elif v != parent[u]:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_11 = ((__pyx_v_v != (*((int *) ( /* dim=0 */ (__pyx_v_parent.data + __pyx_t_27 * __pyx_v_parent.strides[0]) )))) != 0);
    if (__pyx_t_11) {

      /* "utils/articulation_points.pyx":61
 *         # Update low value of u for parent function calls
 *         elif v != parent[u]:
 *             low[u] = min(low[u], disc[v])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_18 = (*((double *) ( /* dim=0 */ (__pyx_v_disc.data + __pyx_t_28 * __pyx_v_disc.strides[0]) )));
      __pyx_t_29 = __pyx_v_u;
      __pyx_t_15 = (*((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_29 * __pyx_v_low.strides[0]) )));
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_low.data + __pyx_t_30 * __pyx_v_low.strides[0]) )) = __pyx_t_17;
 ...
 */
  ...
  __Pyx_AddTraceback("utils.articulation_points.APUtil", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "utils/articulation_points.pyx":63
 *             low[u] = min(low[u], disc[v])
 * 
 * cpdef int[:] articulationPoints(int[:] tile_districts, map) except *:             # <<<<<<<<<<<<<<
 *     cdef int time = 0
...
static PyObject *__pyx_pw_5utils_19articulation_points_1articulationPoints(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_5utils_19articulation_points_articulationPoints(__Pyx_memviewslice __pyx_v_tile_districts, PyObject *__pyx_v_map, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_time;
  int __pyx_v_n;
  int __pyx_v_t;
  ...
  __Pyx_memviewslice __pyx_v_disc = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  Py_ssize_t __pyx_t_12;
  int __pyx_t_13;
  __Pyx_RefNannySetupContext("articulationPoints", 0);

  /* "utils/articulation_points.pyx":64
 * 
 * cpdef int[:] articulationPoints(int[:] tile_districts, map) except *:
 *     cdef int time = 0             # <<<<<<<<<<<<<<
 *     cdef int n, t
 ...
 */
  ...
  /* "utils/articulation_points.pyx":66
 *     cdef int time = 0
 *     cdef int n, t
 *     n = map.n_tiles             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_map, __pyx_n_s_n_tiles); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
  ...
  /* "utils/articulation_points.pyx":67
 *     cdef int n, t
 *     n = map.n_tiles
 *     cdef int[:] visited = np.zeros(n, dtype='i')             # <<<<<<<<<<<<<<
 *     cdef int[:] parent = np.full(n, -1.0, dtype='i')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_n_s_i) < 0) __PYX_ERR(0, 67, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_visited = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "utils/articulation_points.pyx":68
 *     n = map.n_tiles
 *     cdef int[:] visited = np.zeros(n, dtype='i')
 *     cdef int[:] parent = np.full(n, -1.0, dtype='i')             # <<<<<<<<<<<<<<
 *     cdef int[:] ap = np.zeros(n, dtype='i')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_full); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_n_s_i) < 0) __PYX_ERR(0, 68, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_parent = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "utils/articulation_points.pyx":69
 *     cdef int[:] visited = np.zeros(n, dtype='i')
 *     cdef int[:] parent = np.full(n, -1.0, dtype='i')
 *     cdef int[:] ap = np.zeros(n, dtype='i')             # <<<<<<<<<<<<<<
 *     cdef double[:] low = np.full(n, np.inf)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_i) < 0) __PYX_ERR(0, 69, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_ap = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "utils/articulation_points.pyx":70
 *     cdef int[:] parent = np.full(n, -1.0, dtype='i')
 *     cdef int[:] ap = np.zeros(n, dtype='i')
 *     cdef double[:] low = np.full(n, np.inf)             # <<<<<<<<<<<<<<
 *     cdef double[:] disc = np.full(n, np.inf)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_full); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_inf); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  if (PyFunction_Check(__pyx_t_4)) {
    ...
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_2, 2+__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_t_3, __pyx_t_7};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_2, 2+__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  ...
  #endif
  {
    __pyx_t_8 = PyTuple_New(2+__pyx_t_2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  /* "utils/articulation_points.pyx":71
 *     cdef int[:] ap = np.zeros(n, dtype='i')
 *     cdef double[:] low = np.full(n, np.inf)
 *     cdef double[:] disc = np.full(n, np.inf)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_full); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_inf); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = NULL;
  __pyx_t_2 = 0;
  ...
  if (PyFunction_Check(__pyx_t_8)) {
    ...
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_2, 2+__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
    PyObject *__pyx_temp[3] = {__pyx_t_7, __pyx_t_4, __pyx_t_3};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_2, 2+__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_disc = __pyx_t_9;
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;

  /* "utils/articulation_points.pyx":73
 *     cdef double[:] disc = np.full(n, np.inf)
 * 
 *     for t in range(n):             # <<<<<<<<<<<<<<
 *         if not visited[t]:
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "utils/articulation_points.pyx":74
 * 
 *     for t in range(n):
 *         if not visited[t]:             # <<<<<<<<<<<<<<
 *             APUtil(&time, tile_districts, map, t, visited, ap, parent, low, disc)
 ...
 */
    ...
    __pyx_t_13 = ((!((*((int *) ( /* dim=0 */ (__pyx_v_visited.data + __pyx_t_12 * __pyx_v_visited.strides[0]) ))) != 0)) != 0);
    if (__pyx_t_13) {

      /* "utils/articulation_points.pyx":75
 *     for t in range(n):
 *         if not visited[t]:
 *             APUtil(&time, tile_districts, map, t, visited, ap, parent, low, disc)             # <<<<<<<<<<<<<<
 * 
 *     return ap
 */
      __pyx_t_1 = __pyx_f_5utils_19articulation_points_APUtil((&__pyx_v_time), __pyx_v_tile_districts, __pyx_v_map, __pyx_v_t, __pyx_v_visited, __pyx_v_ap, __pyx_v_parent, __pyx_v_low, __pyx_v_disc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  /* "utils/articulation_points.pyx":77
 *             APUtil(&time, tile_districts, map, t, visited, ap, parent, low, disc)
 * 
 *     return ap             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __PYX_INC_MEMVIEW(&__pyx_v_ap, 0);
  __pyx_r = __pyx_v_ap;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("utils.articulation_points.articulationPoints", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_low, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_disc, 1);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_5utils_19articulation_points_1articulationPoints(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5utils_19articulation_points_1articulationPoints(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_tile_districts = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_map = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("articulationPoints (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_tile_districts,&__pyx_n_s_map,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tile_districts)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_map)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("articulationPoints", 1, 2, 2, 1); __PYX_ERR(0, 63, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "articulationPoints") < 0)) __PYX_ERR(0, 63, __pyx_L3_error)
      }
    ...
    __pyx_v_tile_districts = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_tile_districts.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_map = values[1];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("articulationPoints", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 63, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("utils.articulation_points.articulationPoints", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5utils_19articulation_points_articulationPoints(__pyx_self, __pyx_v_tile_districts, __pyx_v_map);
...
static PyObject *__pyx_pf_5utils_19articulation_points_articulationPoints(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_tile_districts, PyObject *__pyx_v_map) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_5utils_19articulation_points_articulationPoints(__pyx_v_tile_districts, __pyx_v_map, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 63, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 63, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_tile_districts, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "utils.articulation_points.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "utils.articulation_points.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "utils.articulation_points.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "utils.articulation_points._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"articulationPoints", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5utils_19articulation_points_1articulationPoints, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_articulation_points(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_articulation_points},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_tile_districts, __pyx_k_tile_districts, sizeof(__pyx_k_tile_districts), 0, 0, 1, 1},
  {&__pyx_n_s_tile_neighbours, __pyx_k_tile_neighbours, sizeof(__pyx_k_tile_neighbours), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initarticulation_points(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initarticulation_points(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_articulation_points(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_articulation_points(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_articulation_points(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'articulation_points' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_articulation_points(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("articulation_points", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_utils__articulation_points) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "utils.articulation_points")) {
      if (unlikely(PyDict_SetItemString(modules, "utils.articulation_points", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "utils/articulation_points.pyx":8
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "utils/articulation_points.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init utils.articulation_points", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init utils.articulation_points");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
